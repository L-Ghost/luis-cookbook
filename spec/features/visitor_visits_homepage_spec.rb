...
feature 'Visitor visits homepage' do
  ...
  scenario 'and view recipes list' do
    ...
    recipe = Recipe.create(title: 'Pão de Queijo de Beterraba', difficulty: 'Médio',
        recipe_type: 'Entrada', cuisine: 'Brasileira', cook_time: 40,
    ...
    recipe2 = Recipe.create(title: 'Peixinho da Horta', difficulty: 'Fácil',
        recipe_type: 'Prato Principal', cuisine: 'Portuguesa', cook_time: 30,
    ...
    expect(page).to have_css('li', text: recipe2.recipe_type)
    expect(page).to have_css('li', text: recipe2.cuisine)
